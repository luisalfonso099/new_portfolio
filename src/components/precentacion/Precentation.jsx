        ...
        <section className="precentacion-container" id="home">
            ...
            <div className="content-text-precentation p-7">
                ...
                <div className={`mt-14 ${darkTheme ?  'text-white font-thin' : 'font-extralight '}`}>
                    <p className="sm:text-xl leading-7">Cuento con experiencia en una variedad de tecnologías front-end. Mi objetivo principal es construir aplicaciones web que mejoren y transformen la experiencia del usuario.</p>
